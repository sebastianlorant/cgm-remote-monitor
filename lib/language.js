...
// food editor
    ...
    ,'Find and remove treatments in the future' : {
      ...
      ,sv: 'Sök och ta bort framtida händelse'
    ...
    ,'This task find and remove treatments in the future.' : {
      ...
      ,sv: 'Denna sökning hittar och tar bort framtida händelser'
    ...
    ,'Find and remove entries in the future' : {
      ...
      ,sv: 'Hitta och ta bort framtida poster'
    ...
    ,'This task find and remove CGM data in the future created by uploader with wrong date/time.' : {
      ...
      ,sv: 'Denna sökning hittar och tar bort framtida CRM data skapade av uppladdaren med felaktig datum/tid'
    ...
    ,'Remove entries in the future' : {
      ...
      ,sv: 'Ta bort alla framtida sensorhändelser'
    ...
    ,'Database contains %1 future records' : {
      ...
      ,sv: 'Databasen innehåller %1 framtida händelser'
    ...
    ,'Error removing record %1' : {
      ...
      ,sv: 'Fel vid borttagning av händelse %1'
    ...
    ,'Delete all documents from devicestatus collection' : {
      ...
      ,sv: 'Rensa alla händelser från databas devicestatus'
    ...
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,sv: 'Denna uppgift rensar alla dokument från devicestatus collectionen. Användbart när battteristatus ej uppdateras.'
